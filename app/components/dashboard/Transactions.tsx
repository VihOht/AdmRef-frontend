...
import { useTransactions, useCategories, useCreateTransaction, useDeleteTransaction, useCreateCategory, useAccount } from '~/hooks/use-finance'
...
import type { CreateTransactionDto, TypesTransactionCategory } from '~/types'
    ...
    <div>
      <div className="mb-6 flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-600 mt-2">Gerencie todas as suas transações</p>
        </div>
      ...
      <Card className="p-6">
        <h2 className="text-xl font-semibold mb-4">
          {filteredTransactions.length} {filteredTransactions.length === 1 ? 'Transação' : filteredTransactions.length > 1 ? 'Transações' : 'Nenhuma Transação'}
        </h2>
        {isLoading ? (
